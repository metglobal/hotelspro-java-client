...
import hotelspro_client.auth.Authentication;
import hotelspro_client.auth.HttpBasicAuth;
import hotelspro_client.auth.ApiKeyAuth;
import hotelspro_client.auth.OAuth;
        ...
        for (Entry<String, Object> param : formParams.entrySet()) {
            if(param.getValue() instanceof Collection){
                for(Object o: (Collection)param.getValue()){
                    formBuilder.add(param.getKey(), parameterToString(o));
                } 
            }else{
